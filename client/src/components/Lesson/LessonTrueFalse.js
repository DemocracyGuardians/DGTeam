...
class LessonTrueFalse extends LessonScreenBaseClass {
  ...
  render() {
    ...
    questions.map((item, index) => {
      ...
      rows.push( <label className="LessonTrueFalseTrue">
      ...
      rows.push( <label className="LessonTrueFalseFalse">
      ...
      rows.push( <div className="LessonTrueFalseScore"> <Icon style={scoreStyle} key={(count++).toString()} name={icon} size='large' /> </div> )
    })
    let buttonRow
